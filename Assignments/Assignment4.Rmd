...
# calculate the mean rate for each list_ID
...
write_csv(filter(Matt_ebird, 
                 scientific_name == ebird_top_10[1,1] &
                   scientific_name == ebird_top_10[2,1] &
                   scientific_name == ebird_top_10[3,1] &
                   scientific_name == ebird_top_10[4,1] &
                   scientific_name == ebird_top_10[5,1] &
                   scientific_name == ebird_top_10[6,1] &
                   scientific_name == ebird_top_10[7,1] &
                   scientific_name == ebird_top_10[8,1] &
                   scientific_name == ebird_top_10[9,1] &
                   scientific_name == ebird_top_10[10,1]),
          "ebird_top10.csv")
